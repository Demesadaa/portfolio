(() => {
  ...
  const translations = {
    ka: {
      ...
      'hero.subtitle': 'მათემატიკის რეპეტიტოტი- ვეხმარები მოსწავლეებს აუღონ ალღო მათემატიკის ნებისმიერ სირთულეს',
